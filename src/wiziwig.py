...
<body><p><br></p></body>
        ...
        file_toolbar_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=2)
        ...
        formatting_toolbar_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=2)
        ...
        # Populate color group with color indicators
        # Text color button
        ...
        self.text_color_indicator.set_size_request(16, 3)  # Width: 16px, Height: 2px
        ...
        self.bg_color_indicator.set_size_request(16, 3)  # Width: 16px, Height: 2px
    ...
    def draw_color_indicator(self, area, cr, width, height, data):
        # Draw the color based on the area (text or bg indicator)
    ...
    def on_text_color_dialog_response(self, dialog, result, btn):
        try:
            ...
            if rgba:
                ...
                self.text_color_indicator.queue_draw()  # Update the indicator
    ...
    def on_bg_color_dialog_response(self, dialog, result, btn):
        try:
            ...
            if rgba:
                ...
                self.bg_color_indicator.queue_draw()  # Update the indicator
                color = rgba.to_string()
